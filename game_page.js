...
document.getElementById("player2_score").innerHTML = player2_score;
   ...
   function send(){
       ...
       length_div = Math.floor(word.length/2);
        charAt2 = word.charAt(length_div);
        ...
        length_minus = word.length - 1;
         ...
         input_box = "<br>Answer : <input type='text' id='input_chat_box'>";
   ...
   function check(){
       get_answer = document.getElementById("input_chat_box").value;
